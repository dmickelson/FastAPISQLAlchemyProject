"""
Contains reusable functions to interact with the data in the database for the Item and Store models.

The ItemRepo class provides CRUD (Create, Read, Update, Delete) helper methods for the Item database model.

The StoreRepo class provides CRUD helper methods for the Store database model.
"""
...
# Contains some reusable functions to interact with the data in the database
class ItemRepo:
    # CRUD Helper methods for Item database model.
...
class StoreRepo:
    # CRUD Helper methods for Store database model.
